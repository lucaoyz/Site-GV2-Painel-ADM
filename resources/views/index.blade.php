...
<head>
    ...
    <!-- favicons
    ================================================== -->
    <link rel="icon" type="image/png" href="{{asset('images/ICOGV2.ico')}}">
...
<body id="top">
    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="{{route('index')}}"><img src="images/Logo horizontal mais compacta.png" alt=""></a>
        </div>
    ...
    <section id="about" class="s-about target-section">
        ...
        <div class="row narrow section-intro has-bottom-sep">
            <div class="col-full text-center">
                ...
                <p class="lead" style="color: #888888;">Somos mais que uma academia de musculação, somos um time. Oferecemos o melhor para quem está determinado em treinar, com ampla quantidade de equipamentos e profissionais treinados e dedicados a te levar ao melhor desempenho referente aos seus objetivos. Faça parte do Time GV2!</p>
            </div>
        </div>
